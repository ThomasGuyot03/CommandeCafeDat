        ...
        <div class="columns is-centered">
            <div class="column is-4-tablet is-4-desktop is-3-widescreen">
                ...
                <form @submit.prevent="signup">
                    ...
                    <div class="control">
                        <input class="input" type="text" v-model="firstname" placeholder="exemple">
                    </div>
                    </div>
                    <div class="field">
                    <label class="label">Nom</label>
                    <div class="control">
                        <input class="input" type="text" v-model="lastname" placeholder="exemple">
                    </div>
                    </div>
                    <div class="field">
                    <label class="label is-left">Adresse e-mail</label>
                    <div class="control">
                        <input class="input" type="email" v-model="email" placeholder="exemple@gmail.com">
                    </div>
                    </div>
                    <div class="field">
...
methods: {
    saveUser() {
    // Effectuez ici votre logique de sauvegarde des données utilisateur
